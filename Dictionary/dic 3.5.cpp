...
short boxx = 15, boxy = 6, boxs = 40, boxw = 10; //Vi tri bat dau x, y cua box, box size, so tu hien thi trong khung
...
void addword(hashtable *&tudien) {
	...
	for(int k = 1; k < 10; k++) {
		...
		while(keyhit != 13) {
			...
			else if(dem < boxs - 17 && ((keyhit > 96 && keyhit < 123) || (keyhit > 64 && keyhit < 91) || (keyhit == 32) || (keyhit == 39) || (keyhit == 45) || (keyhit == 63))) {
				if(keyhit == 63) {
					if(k == 7 || k == 8 || k == 9) {
						dem++;
						text += char(keyhit);
			...
			else if((keyhit > 96 && keyhit < 123) || (keyhit > 64 && keyhit < 91) || (keyhit == 32) || (keyhit == 39) || (keyhit == 45) || (keyhit == 63)) {
				if(keyhit == 63) {
					if(k == 7 || k == 8 || k == 9) {
						dem++;
						text += char(keyhit);
...
void editword(hashtable *tudien, word *&hientai) {
	...
	addwordbox();
	menu5();
	gotoxy(boxx + 17, boxy + 1); cout << field[0];
	gotoxy(boxx + 17, boxy + 2); cout << field[1];
	gotoxy(boxx + 17, boxy + 3); cout << field[2];
	gotoxy(boxx + 17, boxy + 4); cout << field[3];
	gotoxy(boxx + 17, boxy + 5); cout << field[4];
	gotoxy(boxx + 17, boxy + 6); cout << field[5];
	gotoxy(boxx + 17, boxy + 7); cout << field[6];
	gotoxy(boxx + 17, boxy + 8); cout << field[7];
	gotoxy(boxx + 17, boxy + 9); cout << field[8];
...
int main() {
	system("color 3f");
	SetConsoleTitle("Dictionary 3.1 by Hoang Khoi Nguyen");
	word *tuhientai = NULL;
