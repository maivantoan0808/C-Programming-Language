...
short boxx = 15, boxy = 5, boxs = 20, boxw = 6; //Vi tri bat dau x, y cua box, box size, so tu hien thi trong khung
...
void menu2() {
	gotoxy(18,2);
	setcolor(63);
	cout << "Tab: Chinh sua tu nay";
	gotoxy(18,3);
	cout << "Esc: Quay lai tim kiem";
	setcolor(63);
}
...
void detailword(word *hientai) { //Ham xuat ra man hinh thong tin chi tiet cua tu can tra
	if(hientai != NULL) {
		short d = 3;
		menu2();
		detailbox(hientai);	
